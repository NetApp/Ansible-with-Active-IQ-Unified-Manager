...
def post():
    ...
    if(protectionservicelevelskey!=None):
        url_path+="protection-service-levels/"+protectionservicelevelskey+"/jobs/"
    else:
    ...
    if (protection_service_level_clone_name != None) & (protection_service_level_clone_name != key):
        payload['protection_service_level_clone_name']=protection_service_level_clone_name
...
def main():
        fields = {
                ...
                "protectionservicelevelskey" : {"required": False, "type": "str"},
                "protection_service_level_key" : {"required": False, "type": "str"},
                "protection_service_level_clone_name" : {"required": False, "type": "str"},
                }
        ...
        global protectionservicelevelskey
        protectionservicelevelskey   = module.params["protectionservicelevelskey"]
        ...
        global protection_service_level_clone_name
        protection_service_level_clone_name = module.params["protection_service_level_clone_name"]
